...
import sys
import pprint
from DocumentParsing.cell_class import CELL, DEBUG
...
def find_rows(cell_list: list[CELL], vertical_threshold=15, horizontal_threshold=30):
	...
	# need to combine line items that are closer than some threshold to each
	# other on the horizontal axis AND are majority numbers. This is to catch
	# things like
	#   "$ 3,455,555"
	# being recognized as
	#   $  +  3,455,55  +  5
